from src.highz_exp import file_load, spec_plot
import numpy as np
...
if __name__ == "__main__":
    ...
    dbm_spec_states = file_load.preprocess_states(faxis=faxis_hz, loaded_spec_states=loaded_spec_states, remove_spikes=False, offset=-128, system_gain=0)
    spec_plot.plot_spectrum(dbm_spec_states, save_dir=spec_path, suffix='raw', freq_range=freq_range, ymin=-80, ymax=-30)
